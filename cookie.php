...
$dynamicCookie = getDynamicCookie($_GET['channel']);

// Set the appropriate headers for M3U8 content
...
$jsonOutput = json_encode($m3u8Data, JSON_PRETTY_PRINT);
